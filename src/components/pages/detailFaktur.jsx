...
export const DetailFaktur = ({onClose}) => {
    ...
    return(
        <div className="w-140 max-h-[90vh] flex flex-col overflow-y-auto scrollbar-thin bg-white rounded-xl">
            ...
            <div className='p-4 gap-2.5 flex flex-col'>
                ...
                {orderItems.map((data) => (
                    <div key={data.id} className="grid grid-cols-12 text-sm gap-4 py-2.5 border-t border-gray-200">
